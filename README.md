...
#### Definição:
------------------
[__Proumo$__](http://proumos.com) é um Gateway de pagamentos por meios digitais de baixo custo e de fácil implantação com uma Moeda Virtual ([__Pr$__](http://proumos.com)) de descontos em vendas em massa em __aplicações__ e por pessoas comuns.
